...
class CpOpinionLocationServiceTest {
    ...
    @InjectMocks
    private CpOpinionLocationService cpOpinionLocationService;

    @Mock
    private CpOpinionLocationRepository cpOpinionLocationRepository;
    ...
    @Test
    @DisplayName("CP 버전 시퀀스에 따라 활성 상태의 CP 의견 위치 목록을 조회")
