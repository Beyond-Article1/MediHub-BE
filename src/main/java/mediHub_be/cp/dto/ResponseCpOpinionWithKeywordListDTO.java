...
@Data
@Builder
public class ResponseCpOpinionWithKeywordListDTO {
    ...
    public static ResponseCpOpinionWithKeywordListDTO create(ResponseCpOpinionDTO data, List<Keyword> keywordList) {
        return ResponseCpOpinionWithKeywordListDTO.builder()
