...
INSERT INTO medical_life (user_seq, dept_seq, part_seq, medical_life_title, medical_life_content,
                          medical_life_is_draft, created_at, updated_at, deleted_at) VALUES
                                                                                         (1, 1, 1, '의료 생활 제목 1', '의료 생활 내용 1', false, NOW(), NULL, NULL),
                                                                                         (2, 1, 1, '의료 생활 제목 2', '의료 생활 내용 2', false, NOW(), NULL, NULL),
                                                                                         (3, 1, 1, '의료 생활 제목 3', '의료 생활 내용 3', false, NOW(), NULL, NULL),
                                                                                         (4, 1, 1, '의료 생활 제목 4', '의료 생활 내용 4', false, NOW(), NULL, NULL),
                                                                                         (5, 1, 1, '의료 생활 제목 5', '의료 생활 내용 5', false, NOW(), NULL, NULL),
                                                                                         (6, 1, 1, '의료 생활 제목 6', '의료 생활 내용 6', false, NOW(), NULL, NULL),
                                                                                         (7, 1, 1, '의료 생활 제목 7', '의료 생활 내용 7', false, NOW(), NULL, NULL),
                                                                                         (8, 1, 1, '의료 생활 제목 8', '의료 생활 내용 8', false, NOW(), NULL, NULL),
