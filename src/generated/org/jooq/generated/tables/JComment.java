...
public class JComment extends TableImpl<CommentRecord> {
    ...
    private JComment(Name alias, Table<CommentRecord> aliased) {
        this(alias, aliased, (Field<?>[]) null, null);
    }

    private JComment(Name alias, Table<CommentRecord> aliased, Field<?>[] parameters, Condition where) {
    ...
    public <O extends Record> JComment(Table<O> path, ForeignKey<O, CommentRecord> childPath, InverseForeignKey<O, CommentRecord> parentPath) {
     ...
     */
    public static class CommentPath extends JComment implements Path<CommentRecord> {
    ...
    @Override
    public JComment as(Table<?> alias) {
        return new JComment(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public JComment rename(Table<?> name) {
        return new JComment(name.getQualifiedName(), null);
    }
     ...
     */
    @Override
    public JComment where(Condition condition) {
        return new JComment(getQualifiedName(), aliased() ? this : null, null, condition);
    }
     ...
     */
    @Override
    public JComment where(Collection<? extends Condition> conditions) {
     ...
     */
    @Override
    public JComment where(Condition... conditions) {
        return where(DSL.and(conditions));
    }
     ...
     */
    @Override
    public JComment where(Field<Boolean> condition) {
    ...
    @Override
    @PlainSQL
    public JComment where(SQL condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public JComment where(@Stringly.SQL String condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public JComment where(@Stringly.SQL String condition, Object... binds) {
    ...
    @Override
    @PlainSQL
    public JComment where(@Stringly.SQL String condition, QueryPart... parts) {
     ...
     */
    @Override
    public JComment whereExists(Select<?> select) {
     ...
     */
    @Override
    public JComment whereNotExists(Select<?> select) {
