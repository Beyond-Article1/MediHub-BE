...
import org.jooq.generated.tables.JCaseSharingGroup.CaseSharingGroupPath;
...
public class JCaseSharing extends TableImpl<CaseSharingRecord> {
     ...
     */
    public static final JCaseSharing CASE_SHARING = new JCaseSharing();
    ...
    private JCaseSharing(Name alias, Table<CaseSharingRecord> aliased) {
        this(alias, aliased, (Field<?>[]) null, null);
    }

    private JCaseSharing(Name alias, Table<CaseSharingRecord> aliased, Field<?>[] parameters, Condition where) {
     ...
     */
    public JCaseSharing(String alias) {
     ...
     * Create an aliased <code>medihub.case_sharing</code> table reference
     */
    public JCaseSharing(Name alias) {
    ...
    public <O extends Record> JCaseSharing(Table<O> path, ForeignKey<O, CaseSharingRecord> childPath, InverseForeignKey<O, CaseSharingRecord> parentPath) {
     ...
     */
    public static class CaseSharingPath extends JCaseSharing implements Path<CaseSharingRecord> {
    ...
    @Override
    public JCaseSharing as(String alias) {
        return new JCaseSharing(DSL.name(alias), this);
    }

    @Override
    public JCaseSharing as(Name alias) {
        return new JCaseSharing(alias, this);
    }

    @Override
    public JCaseSharing as(Table<?> alias) {
        return new JCaseSharing(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public JCaseSharing rename(String name) {
        return new JCaseSharing(DSL.name(name), null);
    }
     ...
     */
    @Override
    public JCaseSharing rename(Name name) {
        return new JCaseSharing(name, null);
    }
     ...
     */
    @Override
    public JCaseSharing rename(Table<?> name) {
        return new JCaseSharing(name.getQualifiedName(), null);
    }
     ...
     */
    @Override
    public JCaseSharing where(Condition condition) {
        return new JCaseSharing(getQualifiedName(), aliased() ? this : null, null, condition);
    }
     ...
     */
    @Override
    public JCaseSharing where(Collection<? extends Condition> conditions) {
     ...
     */
    @Override
    public JCaseSharing where(Condition... conditions) {
        return where(DSL.and(conditions));
    }
     ...
     */
    @Override
    public JCaseSharing where(Field<Boolean> condition) {
    ...
    @Override
    @PlainSQL
    public JCaseSharing where(SQL condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public JCaseSharing where(@Stringly.SQL String condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public JCaseSharing where(@Stringly.SQL String condition, Object... binds) {
    ...
    @Override
    @PlainSQL
    public JCaseSharing where(@Stringly.SQL String condition, QueryPart... parts) {
     ...
     */
    @Override
    public JCaseSharing whereExists(Select<?> select) {
     ...
     */
    @Override
    public JCaseSharing whereNotExists(Select<?> select) {
