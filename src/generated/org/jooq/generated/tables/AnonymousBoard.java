...
public class AnonymousBoard extends TableImpl<AnonymousBoardRecord> {
     ...
     */
    public static final AnonymousBoard ANONYMOUS_BOARD = new AnonymousBoard();
    ...
    private AnonymousBoard(Name alias, Table<AnonymousBoardRecord> aliased) {
        this(alias, aliased, (Field<?>[]) null, null);
    }

    private AnonymousBoard(Name alias, Table<AnonymousBoardRecord> aliased, Field<?>[] parameters, Condition where) {
     ...
     */
    public AnonymousBoard(String alias) {
     ...
     * Create an aliased <code>medihub.anonymous_board</code> table reference
     */
    public AnonymousBoard(Name alias) {
    ...
    public <O extends Record> AnonymousBoard(Table<O> path, ForeignKey<O, AnonymousBoardRecord> childPath, InverseForeignKey<O, AnonymousBoardRecord> parentPath) {
     ...
     */
    public static class AnonymousBoardPath extends AnonymousBoard implements Path<AnonymousBoardRecord> {
    ...
    @Override
    public AnonymousBoard as(String alias) {
        return new AnonymousBoard(DSL.name(alias), this);
    }

    @Override
    public AnonymousBoard as(Name alias) {
        return new AnonymousBoard(alias, this);
    }

    @Override
    public AnonymousBoard as(Table<?> alias) {
        return new AnonymousBoard(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public AnonymousBoard rename(String name) {
        return new AnonymousBoard(DSL.name(name), null);
    }
     ...
     */
    @Override
    public AnonymousBoard rename(Name name) {
        return new AnonymousBoard(name, null);
    }
     ...
     */
    @Override
    public AnonymousBoard rename(Table<?> name) {
        return new AnonymousBoard(name.getQualifiedName(), null);
    }
     ...
     */
    @Override
    public AnonymousBoard where(Condition condition) {
        return new AnonymousBoard(getQualifiedName(), aliased() ? this : null, null, condition);
    }
     ...
     */
    @Override
    public AnonymousBoard where(Collection<? extends Condition> conditions) {
     ...
     */
    @Override
    public AnonymousBoard where(Condition... conditions) {
        return where(DSL.and(conditions));
    }
     ...
     */
    @Override
    public AnonymousBoard where(Field<Boolean> condition) {
    ...
    @Override
    @PlainSQL
    public AnonymousBoard where(SQL condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public AnonymousBoard where(@Stringly.SQL String condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public AnonymousBoard where(@Stringly.SQL String condition, Object... binds) {
    ...
    @Override
    @PlainSQL
    public AnonymousBoard where(@Stringly.SQL String condition, QueryPart... parts) {
     ...
     */
    @Override
    public AnonymousBoard whereExists(Select<?> select) {
     ...
     */
    @Override
    public AnonymousBoard whereNotExists(Select<?> select) {
