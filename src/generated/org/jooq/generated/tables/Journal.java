...
public class Journal extends TableImpl<JournalRecord> {
    ...
    public <O extends Record> Journal(Table<O> path, ForeignKey<O, JournalRecord> childPath, InverseForeignKey<O, JournalRecord> parentPath) {
     ...
     */
    public static class JournalPath extends Journal implements Path<JournalRecord> {
