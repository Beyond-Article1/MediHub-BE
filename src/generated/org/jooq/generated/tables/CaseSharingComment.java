...
public class CaseSharingComment extends TableImpl<CaseSharingCommentRecord> {
     ...
     */
    public static final CaseSharingComment CASE_SHARING_COMMENT = new CaseSharingComment();
    ...
    private CaseSharingComment(Name alias, Table<CaseSharingCommentRecord> aliased) {
        this(alias, aliased, (Field<?>[]) null, null);
    }

    private CaseSharingComment(Name alias, Table<CaseSharingCommentRecord> aliased, Field<?>[] parameters, Condition where) {
     ...
     * reference
     */
    public CaseSharingComment(String alias) {
     ...
     * reference
     */
    public CaseSharingComment(Name alias) {
    ...
    public <O extends Record> CaseSharingComment(Table<O> path, ForeignKey<O, CaseSharingCommentRecord> childPath, InverseForeignKey<O, CaseSharingCommentRecord> parentPath) {
     ...
     */
    public static class CaseSharingCommentPath extends CaseSharingComment implements Path<CaseSharingCommentRecord> {
    ...
    @Override
    public CaseSharingComment as(String alias) {
        return new CaseSharingComment(DSL.name(alias), this);
    }

    @Override
    public CaseSharingComment as(Name alias) {
        return new CaseSharingComment(alias, this);
    }

    @Override
    public CaseSharingComment as(Table<?> alias) {
        return new CaseSharingComment(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public CaseSharingComment rename(String name) {
        return new CaseSharingComment(DSL.name(name), null);
    }
     ...
     */
    @Override
    public CaseSharingComment rename(Name name) {
        return new CaseSharingComment(name, null);
    }
     ...
     */
    @Override
    public CaseSharingComment rename(Table<?> name) {
        return new CaseSharingComment(name.getQualifiedName(), null);
    }
     ...
     */
    @Override
    public CaseSharingComment where(Condition condition) {
        return new CaseSharingComment(getQualifiedName(), aliased() ? this : null, null, condition);
    }
     ...
     */
    @Override
    public CaseSharingComment where(Collection<? extends Condition> conditions) {
     ...
     */
    @Override
    public CaseSharingComment where(Condition... conditions) {
        return where(DSL.and(conditions));
    }
     ...
     */
    @Override
    public CaseSharingComment where(Field<Boolean> condition) {
    ...
    @Override
    @PlainSQL
    public CaseSharingComment where(SQL condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public CaseSharingComment where(@Stringly.SQL String condition) {
        return where(DSL.condition(condition));
    }
    ...
    @Override
    @PlainSQL
    public CaseSharingComment where(@Stringly.SQL String condition, Object... binds) {
    ...
    @Override
    @PlainSQL
    public CaseSharingComment where(@Stringly.SQL String condition, QueryPart... parts) {
     ...
     */
    @Override
    public CaseSharingComment whereExists(Select<?> select) {
     ...
     */
    @Override
    public CaseSharingComment whereNotExists(Select<?> select) {
